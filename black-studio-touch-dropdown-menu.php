...
$black_studio_touch_dropdown_menu_version = "0.1"; // This is used internally - should be the same reported on the plugin header

add_action( 'wp_print_scripts', 'black_studio_touch_dropdown_menu_scripts');
