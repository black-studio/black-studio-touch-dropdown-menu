...
module.exports = function( grunt ) {
	...
	grunt.initConfig({
		...
		makepot: {
			target: {
				options: {
					...
					exclude: ['build/.*'],
					potFilename: 'black-studio-touch-dropdown-menu.pot',
					processPot: function( pot ) {
						pot.headers['report-msgid-bugs-to'] = 'https://github.com/black-studio/black-studio-touch-dropdown-menu/issues\n';
		...
		checktextdomain: {
			options:{
				text_domain: 'black-studio-touch-dropdown-menu',
				keywords: [
					'__:1,2d',
					'_e:1,2d',
					'_x:1,2c,3d',
		...
		checkwpversion: {
			options:{
				readme: 'readme.txt',
				plugin: 'black-studio-touch-dropdown-menu.php'
			},
